...
@section('title', 'Gestionar T. Productos')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive text-nowrap">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('tipoproductos.edit', $rs->id)}}"><i class="bx bx-edit-alt me-1"></i> Editar</a>
                                                
                                               

                                                <form action="{{ route('tipoproductos.destroy', $rs->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                ...
                @if($tipoproductos->count() == 1 || $tipoproductos->count() == 2)
                <br>
                <br>
                <br>
                @endif
