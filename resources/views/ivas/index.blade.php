    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="demo-inline-spacing d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('ivas.create') }}" class="btn btn-info">Nuevo</a>
            </div>
            <br>
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                    ...
                    <tbody>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('ivas.edit', $rs->id)}}"><i class="bx bx-edit-alt me-1"></i> Editar</a>
                                                
                                               

                                                <form action="{{ route('ivas.destroy', $rs->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        @else
                            <tr>
                                <td class="text-center" colspan="5">Iva no encontrado</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
                @if($ivas->count() == 1 || $ivas->count() == 2)
                <br>
                <br>
                <br>
                @endif
