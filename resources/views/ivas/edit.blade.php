...
@section('title', 'Editar IVA')
  
@section('contents')
    <form action="{{ route('ivas.update', $iva->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check mt-3">
                                <input class="form-check-input" type="checkbox" value="1" {{ $iva->activo == 1 ? 'checked' : '' }}  id="activo" name="activo" />
