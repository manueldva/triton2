...
<html lang="en">
  <head>
    ...
    <title>{{Auth::user()->empresa->descripcion }} </title>
    <!--{{ config('app.name', 'Sistema Gestion') }}-->
  ...
  <body>
    ...
    <!-- Page JS -->
    <!-- Page JS -->
    <script src="{{ asset('admin_assets/js/ui-modals.js') }}"></script>
    ...
    <script>
      ...
      $('#allempresa_id').on('change', function () {
          var selectedEmpresaId = $(this).val(); // Obtener el valor seleccionado
          
          // Realizar una petición AJAX para actualizar la tabla 'users'
          $.ajax({
              url: '/actualizar-usuario', // Ruta donde manejarás la actualización
              method: 'POST',
              data: {
                  empresa_id: selectedEmpresaId
              },
              success: function (response) {
                  // Lógica de éxito, puedes mostrar un mensaje o realizar otras acciones
                  // Recarga el formulario o la página actual
                  location.reload();
              },
