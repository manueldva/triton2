...
@section('title', 'Gestionar Tipo Membresia')
        ...
        <div class="card-body">
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @if($tipomembresias->count() > 0)
                            @foreach($tipomembresias as $rs)
                                <tr>
                                    <td>
                                        <center>
                 ...
                 @if($tipomembresias->count() == 1 || $tipomembresias->count() == 2)
                <br>
                <br>
                <br>
                @endif
                <br>
                {{ $tipomembresias->appends(['descripcion' => request('descripcion')])->links() }}
            </div>
