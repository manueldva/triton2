...
@section('title', 'Gestionar Sub Categorias')
            ...
            <div class="table-responsive text-nowrap">
                <table class="table table-bordered">
                    ...
                    <tbody>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('subcategorias.edit', $rs->id)}}"><i class="bx bx-edit-alt me-1"></i> Editar</a>
                                                
                                               

                                                <form action="{{ route('subcategorias.destroy', $rs->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        @else
                            <tr>
                                <td class="text-center" colspan="5">Sub Categoria no encontrada</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
                @if($subcategorias->count() == 1 || $subcategorias->count() == 2)
                <br>
                <br>
                <br>
                @endif
